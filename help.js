...
module.exports = {
    ...
    if(prefix == null) {
        ...
        .setTitle(' ***__CONTENTS__***')
        .addFields(
            { name: '📷  | Image (***Page 2***)', value: '\u200B'},
            { name: '🛡   | Moderation (***Page 3*** )', value: '\u200B'},
            { name: '😄  | Fun (***Page 4***', value: '\u200B'},
            { name: '🎉  | Giveaway.................Page 2', value: '\u200B'},
            { name: '🛠   | Utility..................Page 2', value: '\u200B'},
            { name: '⚙   | Config...................Page 2', value: '\u200B'}
